...
class AppProvider extends ChangeNotifier {
  ...
  RealtimeChannel? _pendingChangesChannel;
  ...
  void _setupRealtimePendingChanges() {
    _pendingChangesChannel?.unsubscribe();
    _pendingChangesChannel = Supabase.instance.client
        .channel('public:pending_changes')
        .onPostgresChanges(
